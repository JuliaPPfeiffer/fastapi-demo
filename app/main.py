...
DB = "ktq3td"  # replace with your UVA computing ID / database name
...
# Create a new FastAPI endpoint decorator using the GET method:
# -- add a new function below it w/ a unique name
